# @Author: gaopeng
# @Date:   2018-01-24 13:28:37
# @Last modified by:   gaopeng
# @Last modified time: 2018-01-24 17:12:16
...
def rollback():
    with cd(_REMOTE_BASE_DIR):
        r = run('ls -p -1')
        files = [s[:-1] for s in RE_FILES.spilt(r) if s.startswith('www-') and s.endswith('/')]
