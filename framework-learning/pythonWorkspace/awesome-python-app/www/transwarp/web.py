...
# -*- coding: utf-8 -*-
# @Author: gaopeng
# @Date:   2017-11-22 16:34:15
# @Last modified by:   gaopeng
# @Last modified time: 2018-01-25 19:31:10
...
_RE_TZ = re.compile('^([\+\-])([0-9]{1,2})\:([0-9]{,2})$')
...
class Request(object):
    ...
    def _parse_input(self):
        def _convert(item):
            if isinstance(item, list):
                return [_to_unicode(i.value) for i in list]
            if item.filename:
    ...
    def cookie(self, name, _default=None):
